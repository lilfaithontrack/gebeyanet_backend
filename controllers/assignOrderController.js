...
const getAssignedOrdersForShopper = async (req, res) => {
...
const getAssignedOrdersForDeliveryBoy = async (req, res) => {
...
const getAssignedOrderByPaymentId = async (req, res) => {
...
module.exports = { getAllAssignedOrders, getAssignedOrdersForShopper, getAssignedOrdersForDeliveryBoy, assignOrder, getAssignedOrderByPaymentId, deleteAssignedOrder, updateOrderStatus };
